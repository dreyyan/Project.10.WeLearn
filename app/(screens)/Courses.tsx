...
// STYLES
import { burgerMenuStyles, globalStyles, settingsStyles } from "../../styles/styles"
  ...
  return (
    <View style={globalStyles.screen}>
      ...
      <StatusBar backgroundColor="#1773EA" style="light" />
        {/* TITLE */}
        <View style={settingsStyles.subtitleContainer}>
            <Text style={settingsStyles.subtitle}>COURSES</Text>
        </View>
