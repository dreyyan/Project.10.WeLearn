...
// STYLES
import { burgerMenuStyles, coursesStyles, globalStyles, settingsStyles } from "../../styles/styles"
    ...
    <View style={globalStyles.screen}>
      ...
      <StatusBar backgroundColor="#1773EA" style="light" />
        ...
        <View style={coursesStyles.subtitleContainer}>
            <Text style={coursesStyles.subtitle}>COURSES</Text>
        </View>

      <View style={coursesStyles.titleContainer}>
        <DropDownPicker
      open={courseOpen}
      value={course}
      items={courseItems}
      ...
      disabled={!department}
      style={coursesStyles.dropdownMenu}
      dropDownContainerStyle={coursesStyles.dropdownContainer}
      textStyle={coursesStyles.dropdownText}
      labelStyle={coursesStyles.dropdownLabel}
      placeholderStyle={coursesStyles.dropdownPlaceholder}
      listItemLabelStyle={coursesStyles.dropdownLabel}
      zIndex={999}
      />
      </View>
        {/* MENU BURGER BUTTON */}
